...
def test_extract_valid_first_and_last_name():
    ...
    assert resulting_df["botanist_first_name"].tolist() == ["Gertrude",
                                                            "Eliza"]  # pylint: disable=unsubscriptable-object

    assert resulting_df["botanist_last_name"].tolist() == ["Jekyll",
                                                           "Andrews"]  # pylint: disable=unsubscriptable-object
