...
def download_data_from_s3(client_obj):
    """
...
if __name__ == "__main__":
    ...
    num_plants_watered_x_days_ago=combined_recording_data[combined_recording_data['last_watered'].dt.date==x_days_ago.date()]['last_watered'].nunique()
